...
describe('freshness visibility contract', () => {
  ...
  it('keeps GitHub backup dry run report-only and attached to pull bundles', () => {
    ...
    expect(pullBundlePanel).toContain('Historical report')
    expect(pullBundlePanel).toContain('Repo state changed since this run')
    expect(pullBundlePanel).toContain('Head at run:')
    expect(pullBundlePanel).toContain('Current head:')
    expect(pullBundlePanel).toContain('Report freshness:')
    ...
    expect(types).toContain('repo_head_at_run')
    expect(types).toContain('current_repo_head')
    expect(types).toContain('freshness_reasons')
